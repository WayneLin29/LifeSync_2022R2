...
namespace PX.Objects.AM
{
    ...
    public class BOMCostRoll_Extension : PXGraphExtension<BOMCostRoll_ProtExt, PX.Objects.AM.BOMCostRoll>
    {
        ...
        /// </summary>
        public delegate BOMCostRoll.OperationCosts GetMaterialCostDelegate(AMBomCost currentAMBomCost, IEnumerable<PXResult<AMBomMatl, InventoryItem, INItemSite>> material, bool isMultLevel, out List<string> materialMessage);
        [PXOverride]
        public BOMCostRoll.OperationCosts GetMaterialCost(AMBomCost currentAMBomCost, IEnumerable<PXResult<AMBomMatl, InventoryItem, INItemSite>> material, bool isMultLevel, out List<string> materialMessage, GetMaterialCostDelegate baseMathod)
        {
