...
namespace LUMCustomizations.Graph
{
    public class LumCostRoll : BOMCostRoll
    {
        ...
        /// Copy standard method and add one more parameter to control qty round-up.
        /// </summary>
        protected virtual OperationCosts GetMaterialCost(AMBomCost currentAMBomCost, IEnumerable<PXResult<AMBomMatl, InventoryItem, INItemSite>> material, bool isMultLevel, out List<string> materialMessage, bool roundup = true)
        {
